...
function getData() {
	...
	var DataURL = 'https://raw.githubusercontent.com/jun-isaac/refurb-market/main/json/desktop-detail.json'
	fetch(DataURL)
		.then(function (res) {
...
function showDestail(obj) {
	...
	obj.forEach(function (product, i) {
		...
		var ssd = product.ssd;
		var gpu = product.gpu;
		var mainboard = product.mainboard;
		var os = product.os;
		var as = product.as;
		// console.log('name = ', name);
